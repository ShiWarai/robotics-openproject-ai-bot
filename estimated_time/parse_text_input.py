...
**Примеры**:
1. Ввод: "2 часа на Создать код в проекте разработка робота вчера"
   Вывод: {{ "project_name": "Разработка робота" }}
2. Ввод: "3 часа на создание кода в проекте манипулятор"
   Вывод: {{ "project_name": "Манипулятор ГЭМ-23" }}
